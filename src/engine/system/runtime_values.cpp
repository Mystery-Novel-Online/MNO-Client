...
void engine::runtime::values::storeValue(const std::string& name, const std::string& value)
{
...
std::string engine::runtime::values::resolveVariables(const std::string& input)
{
