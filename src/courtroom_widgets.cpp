...
void Courtroom::connect_widgets()
{
  ...
  connect(ui_slider_vertical_axis, SIGNAL(sliderReleased()), this, SLOT(OnPlayerOffsetsChanged()));
  connect(ui_slider_scale, SIGNAL(sliderReleased()), this, SLOT(OnPlayerOffsetsChanged()));
