...
- `horizontal` (integer): Horizontal offset applied when the preset is active. Unlike the vertical field, this does not set the slider value but instead adds the value to the current slider value when sending a message. 
